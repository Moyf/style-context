...
const en: Messages = {
	...
	settings: {
		...
		groups: { themeContext: 'Theme context', notePathRules: 'Note path rules', localImageVariable: 'Local image variable', backgroundImage: 'Background image', diagnostics: 'Diagnostics' },
		pages: { backgroundDisplay: 'Display', backgroundDisplayDesc: 'Opacity, blending, sizing, and placement of the image layer.', backgroundFilter: 'Filter', backgroundFilterDesc: 'CSS filter adjustments for the image layer. Values left at their defaults are not applied.' },
