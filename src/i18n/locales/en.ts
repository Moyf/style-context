...
const en: Messages = {
	...
	settings: {
		...
		pages: { backgroundAppearance: 'Appearance', backgroundAppearanceDesc: 'Opacity, blending, sizing, placement, and CSS filters for the image layer. Filters left at their defaults are not applied.', interfaceTransparency: 'Interface transparency', interfaceTransparencyDesc: 'Controls for blending the interface into the background layer.', backgroundRandomization: 'Randomize image background', backgroundRandomizationDesc: 'Choose when and where to randomize the background image.' },
