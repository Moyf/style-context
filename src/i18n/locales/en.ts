...
const en: Messages = {
	...
	settings: {
		...
		labels: { publishThemeClass: 'Publish theme class', themeClassPrefix: 'Theme class prefix', publishPathClasses: 'Publish path classes', publishLocalImageVariables: 'Publish local image variables', liveStatus: 'Live status', folder: 'Folder', keyword: 'Keyword', publishBackgroundImage: 'Enable background image', perModeBackground: 'Separate light and dark backgrounds', randomBackgroundOnStartup: 'Choose a random background image on startup', addRandomBackgroundRibbon: 'Add ribbon icon', backgroundFadeDuration: 'Fade duration', disabled: 'Off', backgroundImageValue: 'Image value', lightBackgroundImageValue: 'Light image value', darkBackgroundImageValue: 'Dark image value', backgroundOpacity: 'Image opacity', backgroundBlendMode: 'Blend mode', backgroundSize: 'Background size', backgroundPosition: 'Background position', backgroundRepeat: 'Repeat', backgroundAttachment: 'Attachment', filterBrightness: 'Brightness', filterContrast: 'Contrast', filterSaturate: 'Saturation', filterGrayscale: 'Grayscale', filterSepia: 'Sepia', filterInvert: 'Invert', filterHueRotate: 'Hue rotate', filterBlur: 'Blur', mobileToolbarTransparent: 'Transparent mobile toolbar', statusBarTransparent: 'Transparent status bar', ribbonTransparent: 'Transparent ribbon', titlebarTransparent: 'Transparent title bar' },
		descriptions: {
			...
			backgroundFadeDuration: 'Fade the background image in when it appears and cross-fade when it switches. 0 disables the animation.',
