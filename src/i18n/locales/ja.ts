	...
	settings: {
		...
		tooltips: {
			clickToCopy: (value) => `クリックしてコピー: ${value}`,
				resourceVariableEnabled: 'この画像変数の公開を有効または無効にします', ruleDisabled: 'ルールは無効です', useForBackgroundImage: '背景画像に使用するかどうか。オンにするとランダム選択の対象になります', backgroundImageExcluded: 'ランダムな背景画像の選択対象外です', setCssVariableName: 'CSS 変数名を設定してください', variableNameInvalid: '変数名が無効です', setVaultImagePath: '保管庫内の画像パスを設定してください', imageFileNotFound: '画像ファイルが見つかりません', notAnImageFile: '画像ファイルではありません', variableNotPublished: '変数が公開されていません（モジュールの切り替えを確認してください）',
		},
