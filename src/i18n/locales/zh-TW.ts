...
const zhTW: Messages = {
	...
	settings: {
		...
		descriptions: {
			...
			backgroundImageValue: '填寫完整的 CSS 圖片值，例如 var(--image-1) 或 url("https://example.com/image.jpg")。只寫變數名稱（--image-1）也可以，會自動按 var(--image-1) 處理。遠端 URL 會連線至圖片網站；隨機按鈕會選擇本機圖片變數。',
