...
const zhTW: Messages = {
	...
	settings: {
		...
		groups: { themeContext: '主題內容', notePathRules: '筆記路徑規則', localImageVariable: '本機圖片變數', backgroundImage: '背景圖片', backgroundDisplay: '顯示', backgroundFilter: '濾鏡', backgroundLayout: '版面配置', diagnostics: '診斷' },
			pages: { backgroundAppearance: '外觀', backgroundAppearanceDesc: '背景圖片圖層的不透明度、混合、尺寸、位置與 CSS 濾鏡。濾鏡保持預設值即不生效。', lightBackgroundAppearance: '亮色外觀', darkBackgroundAppearance: '暗色外觀', interfaceTransparency: '介面透明度', interfaceTransparencyDesc: '將介面融入背景圖層的透明度控制。', backgroundRandomization: '隨機化圖像背景', backgroundRandomizationDesc: '設定隨機背景圖片的執行時機與入口。', manageImageVariables: '管理圖片變數', manageImageVariablesDesc: '開啟變數清單，新增、篩選和編輯圖片變數。' },
