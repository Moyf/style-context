...
const zhTW: Messages = {
	...
	settings: {
		...
		groups: { themeContext: '主題內容', notePathRules: '筆記路徑規則', localImageVariable: '本機圖片變數', diagnostics: '診斷' },
		labels: { publishThemeClass: '發布主題類別', themeClassPrefix: '主題類別前綴', publishPathClasses: '發布路徑類別', publishLocalImageVariables: '發布本機圖片變數', liveStatus: '即時狀態', folder: '資料夾', keyword: '關鍵字' },
		descriptions: {
